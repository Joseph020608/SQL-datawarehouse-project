...
-----------------------------------------------------------------
Script purpose:
  This script creates ciews for the gold layer in the data warehouse
  The gold layer represents the final dimension and fact tables

  Each view performs transofrmations and combines data from the silver layer
  to make a clean, enriched and business ready dataset
...
IF OBJECT_ID('gold.dim.customers', 'V') IS NOT NULL
